...
// export const getExamenesUnsa = (req, res) => {
    
//   const query = getQuery(req);

//   ExamenUnsa.find(query)
//     .then((examenesUnsa) => {
//       if (examenesUnsa.length > 1) {
//         res.render('layouts/examenes-unsa', {...config, examenesUnsa: resolve(examenesUnsa)});
//       } else if (examenesUnsa.length > 0) {
//         res.render('layouts/examen-unsa', {...config, examenesUnsa: resolve(examenesUnsa[0])});
//       } else {
...
// En tu controlador para exámenes (examenController.js)
import ExamenUnsa from "../models/examenUnsaModel.js";
